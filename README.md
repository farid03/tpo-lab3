...
## Use-case диаграмма
// TODO
- [ ] допилить тесты на страницу news
- [ ] пересмотреть прецеденты тестирования
  - [ ] придется делать отдельные страницы на каждую из подстраниц сайта (если придется много тестить)
